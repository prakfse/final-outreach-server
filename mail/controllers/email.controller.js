...
module.exports.toSendEmail = async (req, res, next) => {

    console.log("toSendEmail: " + JSON.stringify(req.body)  );
    console.log("Activity: " + JSON.stringify(req.body.activity)  );
    console.log("Event: " + JSON.stringify(req.body.mailCont)  );
    var activity = req.body.activity;
    var any = req.body.mailCont
//     console.log("1111Activity: " + activity  );
//     console.log("111Event: " + JSON.stringify(any)  );
//    return;
    nUsers = [];

    var adminUsers = await ctrlAdmin.getUsersByRole();
