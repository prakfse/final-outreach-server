...
var bulkeventSchema = mongoose.Schema({
    ...
    project: { type: mongoose.Types.ObjectId, ref: 'Project', required: "Project Name can't be empty." },
    regUsers: { type: Array, ref: 'Volreg', default: null },
...
mongoose.model('Event', bulkeventSchema);
